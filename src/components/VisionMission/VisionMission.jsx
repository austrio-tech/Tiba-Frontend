...
// Icons
import { FaEye, FaBullseye, FaHandshake, FaAward, FaHardHat, FaUsers, FaTrophy } from 'react-icons/fa';
    ...
    <section className={styles.visionMission}>
      ...
      <div className={styles.row}>
        <div className={styles.card}>
          ...
          <div className={styles.icon}><FaEye />
        ...
        <div className={styles.card}>
          <div>
          <div className={styles.icon}><FaBullseye />
            <h3 className={styles.cardTitle}>Mission</h3>
            </div>
            <p>
              To continuously develop new techniques and procedures in order to
              improve efficiency & competitiveness in terms of cost.
              To set the standard by which our competitors are measured.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.valuesGrid}>
        <div className={styles.valueCard}>
          ...
          <h4>
            Ethics</h4>
          <p>Uncompromising in our integrity, honesty, and professional conduct.</p>
        </div>
        ...
        <div className={styles.valueCard}>
          ...
          <h4>Safety & Health</h4>
          <p>Ensure a safe and healthy working environment to achieve zero lost-time injury.</p>
        </div>

        <div className={styles.valueCard}>
          <FaUsers className={styles.valueIcon} />
          <h4>People</h4>
          <p>Aspiring to be the employer of choice by providing the best working environment.</p>
        </div>
